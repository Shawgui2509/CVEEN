...
<head>
    ...
    <title>Villa Adèle, - Appt 04</title>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="mt-4">
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                    <img src="offre1v.jpg" alt="Photo 1" class="w-full h-auto rounded-lg shadow">
                    <img src="offre2v.jpg" alt="Photo 2" class="w-full h-auto rounded-lg shadow">
                    <img src="offre3v.jpeg" alt="Photo 3" class="w-full h-auto rounded-lg shadow">
                    <img src="offre4v.jpg" alt="Photo 4" class="w-full h-auto rounded-lg shadow">
                </div>
            </div>
