...
<body class="bg-gray-100">
    ...
    <div class="max-w-7xl mx-auto p-4 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            <h1 class="text-2xl font-bold">Park Plaza London, - Appt 10</h1>

            <!-- Section des Photos -->
            <div class="mt-4">
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                    <img src="img/offre1p.jpg" alt="Photo 1" class="w-full h-auto rounded-lg shadow">
                    <img src="img/offre2p.jpg" alt="Photo 2" class="w-full h-auto rounded-lg shadow">
                    <img src="img/offre3p.png" alt="Photo 3" class="w-full h-auto rounded-lg shadow">
                    <img src="img/offre4p.jpeg" alt="Photo 4" class="w-full h-auto rounded-lg shadow">
                </div>
            </div>

            <p class="text-gray-600">Logement entier · hébergement · Londres, Royaume-Uni,...</p>
